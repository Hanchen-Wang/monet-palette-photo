...
1. **Task and medium** — state the selected mode, strength, presentation profile, final image orientation, and whether the result is a complete painting, selective edit, or flat hybrid artwork.
...
11. **Composition** — focal order, eye path, crop, negative space, and relationship between factual anchor and painted event.
12. **Typography** — exact short text or explicitly no text.
13. **Material and hard avoids** — matte painterly behavior, flat presentation, mode-specific negatives, and no invented motifs.
